...
mod iongraph_tests {
    ...
    fn test_simple_function() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"simple", "effectLeaves":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "mir":{"blocks":[{"ptr":4096, "id":0, "loopDepth":0, "attributes":[], "predecessors":[], "successors":[1], "instructions":[{"ptr":4098, "id":2, "opcode":"Entries bb1", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}, {"ptr":4097, "id":1, "loopDepth":0, "attributes":[], "predecessors":[0], "successors":[], "instructions":[{"ptr":4096, "id":0, "opcode":"Const CBool(true)", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"Any", "effects":{"read":[], "write":[]}}, {"ptr":4097, "id":1, "opcode":"Return v0", "attributes":[], "inputs":[0], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}]}, "lir":{"blocks":[]}}"#);
    }
    ...
    fn test_multiple_instructions() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"multiple_instructions", "effectLeaves":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "mir":{"blocks":[{"ptr":4096, "id":0, "loopDepth":0, "attributes":[], "predecessors":[], "successors":[1], "instructions":[{"ptr":4098, "id":2, "opcode":"Entries bb1", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}, {"ptr":4097, "id":1, "loopDepth":0, "attributes":[], "predecessors":[0], "successors":[], "instructions":[{"ptr":4096, "id":0, "opcode":"Const CBool(true)", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"Any", "effects":{"read":[], "write":[]}}, {"ptr":4097, "id":1, "opcode":"Return v0", "attributes":[], "inputs":[0], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}]}, "lir":{"blocks":[]}}"#);
    }
    ...
    fn test_multiple_successors() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"multiple_successors", "effectLeaves":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "mir":{"blocks":[{"ptr":4096, "id":0, "loopDepth":0, "attributes":[], "predecessors":[], "successors":[1], "instructions":[{"ptr":4102, "id":6, "opcode":"Entries bb1", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}, {"ptr":4097, "id":1, "loopDepth":0, "attributes":[], "predecessors":[0], "successors":[2, 3], "instructions":[{"ptr":4096, "id":0, "opcode":"Const CBool(true)", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"Any", "effects":{"read":[], "write":[]}}, {"ptr":4097, "id":1, "opcode":"CondBranch v0, bb2(), bb3()", "attributes":[], "inputs":[0], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}, {"ptr":4098, "id":2, "loopDepth":0, "attributes":[], "predecessors":[1], "successors":[], "instructions":[{"ptr":4098, "id":2, "opcode":"Const CBool(true)", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"Any", "effects":{"read":[], "write":[]}}, {"ptr":4099, "id":3, "opcode":"Return v2", "attributes":[], "inputs":[2], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}, {"ptr":4099, "id":3, "loopDepth":0, "attributes":[], "predecessors":[1], "successors":[], "instructions":[{"ptr":4100, "id":4, "opcode":"Const CBool(false)", "attributes":[], "inputs":[], "uses":[], "memInputs":[], "type":"Any", "effects":{"read":[], "write":[]}}, {"ptr":4101, "id":5, "opcode":"Return v4", "attributes":[], "inputs":[4], "uses":[], "memInputs":[], "type":"", "effects":{"read":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"], "write":["Allocator", "Control", "InterruptFlag", "Locals", "Other", "PC", "PatchPoint", "Stack", "Stats"]}}]}]}, "lir":{"blocks":[]}}"#);
    }
 }
