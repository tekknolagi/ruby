...
mod iongraph_tests {
    ...
    fn test_simple_function() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"simple", "mir":{"blocks":[]}, "lir":{"blocks":[]}}"#);
    }
    ...
    fn test_two_blocks() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"two_blocks", "mir":{"blocks":[]}, "lir":{"blocks":[]}}"#);
    }
    ...
    fn test_multiple_instructions() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"multiple_instructions", "mir":{"blocks":[]}, "lir":{"blocks":[]}}"#);
    }
    ...
    fn test_conditional_branch() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"conditional_branch", "mir":{"blocks":[]}, "lir":{"blocks":[]}}"#);
    }
    ...
    fn test_loop_structure() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"loop_structure", "mir":{"blocks":[]}, "lir":{"blocks":[]}}"#);
    }
    ...
    fn test_multiple_successors() {
        ...
        assert_snapshot!(json.to_string(), @r#"{"name":"multiple_successors", "mir":{"blocks":[]}, "lir":{"blocks":[]}}"#);
    }
 }
