...
pub mod abstract_heaps {
  ...
  pub const LocalArray: AbstractHeap = AbstractHeap::from_bits(bits::LocalArray);
...
pub mod effects {
  ...
  pub const LocalArray: Effect = Effect::promote(abstract_heaps::LocalArray);
